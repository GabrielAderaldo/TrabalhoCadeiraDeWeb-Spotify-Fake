...
import logo from '../4/assets/playlistImg.jpg'
...
const playlistJson = db.playlist[3];
const dbJson = [];
...
class Play_music_4 extends Component {
    ...
    componentDidMount(){
        const songs = [];
        axios.get(`http://localhost:8080/playlist/boomer`)
      .then(res => {
    ...
    render(){
        ...
        if(songs[3]){
            return (
                <section id="playmusic-4-page-container">
                    <Navbar />
                    <div id="content-wrap">
