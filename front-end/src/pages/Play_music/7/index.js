...
import logo from '../7/assets/playlistImg.jpg'
...
class Play_music_7 extends Component {
    ...
    componentDidMount(){
        const songs = [];
        axios.get(`http://localhost:8080/playlist/trapnacional`)
      .then(res => {
    ...
    render(){
        ...
        if(songs[3]){
            return (
                <section id="playmusic-7-page-container">
                    <Navbar />
                    <div id="content-wrap">
