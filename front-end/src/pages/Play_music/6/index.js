...
import logo from '../6/assets/playlistImg.jpg'
...
class Play_music_6 extends Component {
    ...
    componentDidMount(){
        const songs = [];
        axios.get(`http://localhost:8080/playlist/indiepop`)
      .then(res => {
    ...
    render(){
        ...
        if(songs[3]){
            return (
                <section id="playmusic-6-page-container">
                    <Navbar />
                    <div id="content-wrap">
